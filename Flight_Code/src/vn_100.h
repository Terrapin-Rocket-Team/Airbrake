...
public:
    ...
    {
        setName(name);
        // addColumn(mmfs::FLOAT, accelerationVec.xp, "VN-AX (m/s/s)");
        // addColumn(mmfs::FLOAT, accelerationVec.yp, "VN-AY (m/s/s)");
        // addColumn(mmfs::FLOAT, accelerationVec.zp, "VN-AZ (m/s/s)");
        // addColumn(mmfs::FLOAT, orientationEuler.xp, "VN-ULRX (deg)");
        // addColumn(mmfs::FLOAT, orientationEuler.yp, "VN-ULRY (deg)");
        // addColumn(mmfs::FLOAT, orientationEuler.zp, "VN-ULRZ (deg)");
        // addColumn(mmfs::FLOAT, angularVelocity.xp, "VN-ANGVX (rad/s)");
        // addColumn(mmfs::FLOAT, angularVelocity.yp, "VN-ANGVY (rad/s)");
        // addColumn(mmfs::FLOAT, angularVelocity.zp, "VN-ANGVZ (rad/s)");
        // addColumn(mmfs::FLOAT, magnetometer.xp, "VN-MAGX (uT)");
        // addColumn(mmfs::FLOAT, magnetometer.yp, "VN-MAGY (uT)");
        // addColumn(mmfs::FLOAT, magnetometer.zp, "VN-MAGZ (uT)");
        // addColumn(mmfs::FLOAT, &pressure, "VN-P (Pa)");
        // addColumn(mmfs::FLOAT, &temperature, "VN-T (C)");
        // addColumn(mmfs::FLOAT, &deltaTime, "VN-DT (s)");
        // addColumn(mmfs::FLOAT, deltaVelocity.xp, "VN-DV-X (m/s/s)");
        // addColumn(mmfs::FLOAT, deltaVelocity.yp, "VN-DV-Y (m/s/s)");
        // addColumn(mmfs::FLOAT, deltaVelocity.zp, "VN-DV-Z (m/s/s)");
        // addColumn(mmfs::FLOAT, deltaTheta.xp, "VN-DTH-X (deg/s)");
        // addColumn(mmfs::FLOAT, deltaTheta.yp, "VN-DTH-Y (deg/s)");
        // addColumn(mmfs::FLOAT, deltaTheta.zp, "VN-DTH-Z (deg/s)");
    };
    virtual ~VN_100(){};
